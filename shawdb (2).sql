...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 06, 2015 at 04:20 AM
...
(4, '', 'Guardians of the Galaxy2', 'Chris Pratt, Zoe Saldana, Dave Bautista, Vin Diesel, Bradley Cooper', 'James Gunn', 'Brash space adventurer Peter Quill (Chris Pratt) finds himself the quarry of relentless bounty hunters after he steals an orb coveted by Ronan, a powerful villain. To evade Ronan, Quill is forced into an uneasy truce with four disparate misfits: gun-toting Rocket Raccoon, treelike-humanoid Groot, enigmatic Gamora, and vengeance-driven Drax the Destroyer. But when he discovers the orb''s true power and the cosmic threat it poses, Quill must rally his ragtag group to save the universe.', '122 Minutes', 'July 21, 2014'),
...
--
ALTER TABLE `timeslots`
  MODIFY `timing_ID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=39;
